    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; }
        ...
        @media (max-width: 768px) {
            .header { padding: 10px 16px; min-height: 56px; }
            .header-logo { width: 32px; height: 32px; margin-right: 6px; }
            .header-title { font-size: 1.2em; }
            .header-title span { font-size: 0.7em; }
            .exit-btn { padding: 5px 10px; font-size: 13px; gap: 4px; }
        ...
        @media (max-width: 480px) {
            ...
            .login-form-section { padding: 25px 15px; }
            .login-image-section { padding: 10px; }
            .login-image-section img { max-height: 180px; }
        }
    </style>
</head>
<body>
